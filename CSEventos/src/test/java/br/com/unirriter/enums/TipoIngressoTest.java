...
public class TipoIngressoTest {
	...
	public void validarTipoIngressoVIPValor1000() {
		...
		assertEquals(BigDecimal.valueOf(1000), tipoIngresso.getValor());
	}
	...
	public void validarTipoIngressoBackstageValor800() {
		...
		assertEquals(BigDecimal.valueOf(800), tipoIngresso.getValor());
	}
	...
	public void validaTipoIngressoPlateiaVIPValor500() {
		...
		assertEquals(BigDecimal.valueOf(500), tipoIngresso.getValor());
	}
	...
	public void validaTipoIngressoPlateiaValor300() {
		...
		assertEquals(BigDecimal.valueOf(300), tipoIngresso.getValor());
	}
}
